...
#
# Generated Sun Apr 26 14:46:48 2020 by generateDS.py version 2.35.21.
...
#
# Command line:
#   /Library/Frameworks/Python.framework/Versions/3.8/bin/generateDS.py -o "schema.py" schema.xsd
#
...
class device(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, vendor=None, model=None, osver=None, gds_collector_=None, **kwargs_):
    ...
    def get_osver(self):
        return self.osver
    def set_osver(self, osver):
        self.osver = osver
    def hasContent_(self):
        if (
            self.vendor is not None or
            self.model is not None or
            self.osver is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='device', fromsubclass_=False, pretty_print=True):
        ...
        if self.osver is not None:
            namespaceprefix_ = self.osver_nsprefix_ + ':' if (UseCapturedNS_ and self.osver_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sosver>%s</%sosver>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.osver), input_name='osver')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'osver':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'osver')
            value_ = self.gds_validate_string(value_, node, 'osver')
            self.osver = value_
            self.osver_nsprefix_ = child_.prefix
# end class device
